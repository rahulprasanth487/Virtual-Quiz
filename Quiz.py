...
while True:
    ...
    if qNo < qTotal:
        ...
        img, bbox2 = cvzone.putTextRect(img, mcq.choice2, [750, 300], 2, 2, offset=50, border=5)
        img, bbox3 = cvzone.putTextRect(img, mcq.choice3, [150, 530], 2, 2, offset=50, border=5)
        img, bbox4 = cvzone.putTextRect(img, mcq.choice4, [750, 530], 2, 2, offset=50, border=5)

        if hands:
            lmList = hands[0]['lmList']
            cursor = lmList[8]
            print("START FINDING THE DISTANCE")
            # print(lmList[8], lmList[12])
            # print(detector.findDistance(lmList[8][:2], lmList[12][:2],img))
